...
- **admin:** align V3 enrichment action bar ([0186f10](https://github.com/cyclonite69/shadowcheck-web/commit/0186f10bb3890485490f9fde6c28dea2edf05274))
...
- **docker:** auto-detect local DNS resolver for Nginx templates ([039151b](https://github.com/cyclonite69/shadowcheck-web/commit/039151b923e20e7cfc8d151aeac7a3f5f1df83a3))
...
- enable timeframe filter by default to prevent unfiltered initial load ([b0b71ff](https://github.com/cyclonite69/shadowcheck-web/commit/b0b71ffdaf578a14b6e37a6bb3346b8e1a1c00f1))
...
- **filters:** default timeframe filter off ([f99cf38](https://github.com/cyclonite69/shadowcheck-web/commit/f99cf383f83c80894eab8829bc246471673c25ed))
...
- **filters:** make dashcam and residential-camera filters independent ([50af93d](https://github.com/cyclonite69/shadowcheck-web/commit/50af93dbaab38c9154da0cb7c405cea6a12552f6))
...
- **filters:** preserve surveillance category predicates ([a7a5e58](https://github.com/cyclonite69/shadowcheck-web/commit/a7a5e585fff252055256de789e7cbe0f8acaa408))
...
- **networks-explorer:** widen BSSID column to fit copy button ([03d2439](https://github.com/cyclonite69/shadowcheck-web/commit/03d243900f62c261cb5698e4907fd2387dea1f62))
...
- **pgadmin:** repair local database network and saved hosts ([e468263](https://github.com/cyclonite69/shadowcheck-web/commit/e4682639cf51e6349e0c70522f0283314500a1f1))
- **pgadmin:** resolve database host from DB_HOST and repair saved connections ([ad87ab5](https://github.com/cyclonite69/shadowcheck-web/commit/ad87ab5a1bea7a7c2f61c2039c3aee8068697b25))
...
- sibling refresh OOM heap, incremental param, bounded poll with UI feedback ([8a8922e](https://github.com/cyclonite69/shadowcheck-web/commit/8a8922e2e05162a3f1339644f3c0a56c9c620987))
...
- **sync:** patch Overpass endpoints, enforce POST+User-Agent, and catch aborts ([abeba19](https://github.com/cyclonite69/shadowcheck-web/commit/abeba191618a638f7f48b589e76becec14cb361f))
...
- **admin-db:** centralize destructive-query guard ([5e09121](https://github.com/cyclonite69/shadowcheck-web/commit/5e091213842fe961d24040059cb4742776c9a327))
...
- **deflock:** import and expose rich FLOCK camera metadata ([482f19b](https://github.com/cyclonite69/shadowcheck-web/commit/482f19bda4df0905544d3e4641d6d4a3e27f4e6a))
...
- **networks-explorer:** add copy-to-clipboard for SSID column ([c2ecf6a](https://github.com/cyclonite69/shadowcheck-web/commit/c2ecf6acb60a72f07e490414e90e7ba27c1e1d53))
...
- **surveillance:** add camera detection and evidence filters ([5da1ee7](https://github.com/cyclonite69/shadowcheck-web/commit/5da1ee7c3cd92981cca635870d9532a467329173))
...
- **visint:** enforce explicit confirmation for unmatched fallback correlation ([82761ba](https://github.com/cyclonite69/shadowcheck-web/commit/82761babee2b22fc8efcce2bf1fba1e3658afc53))
