/**
 * Color palettes for analytics charts.
 * Pure TypeScript — no JSX — safe to import in Node test environments.
 */
 ...
 * All labels from CANONICAL_SECURITY_LABELS must have an entry here.
 */
