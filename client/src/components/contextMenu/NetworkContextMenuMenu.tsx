...
export const NetworkContextMenuMenu = ({
  ...
  >
    <button
      onClick={() => {
        console.log('[DEBUG] clicked: threat');
        onTagNetwork('threat');
      }}
    ...
    <button
      onClick={() => {
        console.log('[DEBUG] clicked: investigate');
        onTagNetwork('investigate');
      }}
    ...
    <button
      onClick={() => {
        console.log('[DEBUG] clicked: false_positive');
        onTagNetwork('false_positive');
      }}
    ...
    <button
      onClick={() => {
        console.log('[DEBUG] clicked: ignore');
        onTagNetwork('ignore');
      }}
