...
commands = [
    f"echo \"{escaped_sql}\" > /tmp/update_config.sql",
    "sudo docker exec shadowcheck_postgres env PGPASSWORD=zJ346bJvKOoyPq9B3bVfmcBXhyycbnkQ psql -U shadowcheck_admin -d shadowcheck_db -f /tmp/update_config.sql"
]
