-- Update security parsing in materialized view to handle modern WiFi security types
-- This fixes the high number of "Unknown" security types

-- First recreate the materialized view with improved security parsing
DROP VIEW IF EXISTS public.api_network_explorer CASCADE;
DROP MATERIALIZED VIEW IF EXISTS public.api_network_explorer_mv;

-- Recreate with improved security parsing
